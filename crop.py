...
def main():
    ...
    parser.add_argument('--top', type=int, default=30, help='Height of top black bar (default: 30)')
    parser.add_argument('--bottom', type=int, default=30, help='Height of bottom black bar (default: 30)')
    parser.add_argument('--cut-start', type=float, default=0, help='Duration to cut from the beginning of the video in seconds (default: 10)')
    parser.add_argument('--cut-end', type=float, default=0, help='Duration to cut from the end of the video in seconds (default: 0)')
